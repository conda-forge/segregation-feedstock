...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/segregation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/segregation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add segregation
# for installing globally
pixi global install segregation
```
...
It is possible to list all of the versions of `segregation` available on your platform:
...
```
pixi search segregation --channel conda-forge
```
